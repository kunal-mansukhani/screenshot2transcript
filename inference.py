...
def tflite_detect_images(modelpath, imgpath, lblpath, min_conf=0.5, num_test_images=2, savepath='/content/results', txt_only=False):
...
PATH_TO_IMAGES='data/training/images'   # Path to test images folder
